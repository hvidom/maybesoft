      ...
      for (const file of response.data) {
        if (file.name.endsWith(".md")) {
          ...
          if (rawContent) {
            ...
            let displayImage = "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=600";
            ...
            posts.push({
              ...
              date: frontmatter.pubDate ? new Date(frontmatter.pubDate).toLocaleDateString('en-US', {
                year: 'numeric',
                month: 'long',
                day: 'numeric'
              }) : "Unknown Date",
